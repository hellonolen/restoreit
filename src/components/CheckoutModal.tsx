    ...
    const tiers = [
        {
            ...
            name: 'restoreit Scan',
            price: 89,
            scanLimit: 'Secure cloud delivery',
            storage: 'restoreit Cloud',
            retention: '7-day support window',
            requiresExternal: false,
            features: [
                'Cloud restoration scan',
                'Quick scan mode',
        ...
        },
        {
            ...
            name: 'restoreit Pro',
            price: 249,
            scanLimit: 'Unlimited re-downloads (7 days)',
            storage: 'Eligible for restoreit Cloud',
            retention: '7-day download window',
            requiresExternal: false,
            features: [
                'Cloud restoration scan',
                'Deep scan & quick scan modes',
                'Damaged file reconstruction',
                'Selective file restoration',
                'Priority restore queue',
                '7-day download window',
                'Unlimited re-downloads (7 days)',
                'Eligible for restoreit Cloud',
            ],
        },
    ];
