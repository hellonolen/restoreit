                ...
                <section className="max-w-3xl mx-auto px-6 md:px-8 space-y-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={item.title} className="p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] space-y-4">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={p.name} className="p-5 rounded-xl border border-white/[0.06] bg-white/[0.01] space-y-2">
