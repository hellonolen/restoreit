        ...
        <div className="flex-1 space-y-8">
          <div>
            ...
            <p className="text-[var(--color-text-tertiary)] text-lg leading-relaxed max-w-lg">
              Flat monthly pricing based on scan volume. Pick your tier and go. Upgrade anytime.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {PARTNER_TIERS.map((t) => (
              <button
                ...
                className={`p-6 rounded-2xl border text-left transition-all relative overflow-hidden ${selectedTier === t.slug
              ...
              >
                ...
                <ul className="space-y-2 text-xs text-[var(--color-text-secondary)] mt-3">
          ...
          <div className="bg-[var(--color-background-elevated)] border border-[var(--color-border)] rounded-2xl p-8 shadow-2xl sticky top-8 space-y-6">
            <div className="flex items-end justify-between">
              ...
              <div className="text-3xl font-bold tracking-tight">
                ${tier.price}<span className="text-[var(--color-text-tertiary)] text-base">.00</span>
              </div>
            </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="border-t border-[var(--color-border-subtle)] pt-3 flex justify-between font-bold">
                ...
                <span>${tier.price}.00{tier.period}</span>
              </div>
            </div>
            ...
            >
              {isProcessing ? (
                ...
                <>Subscribe — ${tier.price}{tier.period} <ArrowRight size={16} /></>
              )}
            </button>

            <p className="text-[10px] text-[var(--color-text-dim)] text-center leading-relaxed">
              You&apos;ll be securely redirected to Whop to complete payment. Upgrade or cancel anytime from your partner dashboard.
            </p>
          </div>
        </div>
      </main>
