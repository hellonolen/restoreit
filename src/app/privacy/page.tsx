...
export default function PrivacyPage() {
    const sections = [
        ...
        { title: 'How We Use Your Data', body: 'Email: to deliver your restore link and product updates (opt-out available). Payment token: to process your one-time charge or subscription. Scan metadata: anonymous aggregate analytics to improve restore algorithms. Nothing is sold to third parties.' },
        { title: 'Data Retention', body: 'Email and transaction records: retained for 7 years for legal and tax compliance. Scan metadata: retained in anonymised form indefinitely. restoreit content: deleted automatically after 7 days (Standard) or 30 days (Pro). All raw disk stream data is discarded immediately after restore.' },
        { title: 'Encryption', body: 'All data in transit uses TLS 1.3. All data at rest in restoreit uses AES-256. Vault access requires email verification and is optionally protected by two-factor authentication.' },
        ...
        { title: 'Zero-Knowledge Principle', body: 'restoreit processes raw binary streams from your disk. Our infrastructure does not read, interpret, or catalogue file content for any purpose other than restore. Employees cannot access the content of your vault. Vault data is encrypted with a key derived from your session — not accessible to restoreit staff.' },
